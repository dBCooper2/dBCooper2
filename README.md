...
\> Currently working on an eportfolio in React and NextJS that can be found [here](https://github.com/dBCooper2/tr-portfolio)(you can make one too, template coming soon!), the old version can be found [here](https://github.com/dBCooper2/dbcooper.io).
